...
const src = 'super-pc.jpg';
const glossaryLangs = ['fr', 'en'];
const projectId = YOUR_PROJECT_ID;
const glossaryName = 'chevre';
const glossaryUri = 'gs://cloud-translation-experience/translation_bistro_glossary.csv';

async function main() {
  try {
    await createGlossary(glossaryLangs, projectId, glossaryName, glossaryUri);
    const text = await picToText(src);
    ...
    syntheticAudio(translatedText, `${src}.mp3`);
  } catch (e) {
